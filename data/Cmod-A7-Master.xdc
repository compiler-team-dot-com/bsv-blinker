...
## LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { led_1 }]; #IO_L12N_T1_MRCC_16 Sch=led[1]
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports { led_2 }]; #IO_L13P_T2_MRCC_16 Sch=led[2]
...
## Buttons
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { btn_pressed }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
...
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { three  }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
